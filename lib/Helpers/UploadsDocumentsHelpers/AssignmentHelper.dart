...
class Assignmenthelper{
  ...
  Future<List<AssignmentModel>> getCreatedAssignments(Map<String, dynamic>? bodydata) async {
    try {
      if (userId == null || token == null) {
        await init();
      }
      final url = 'api/MobileApp/master-admin/$userId/AssignmentReport';
  ...
  Future<Map<String, dynamic>> deleteAssignment(assignmentId) async {
    try {
      ...
      final url = 'api/MobileApp/master-admin/$userId/$assignmentId/RemoveAssignment';
