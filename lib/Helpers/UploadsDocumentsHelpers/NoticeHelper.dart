...
class Noticehelper{
  ...
  Future<List<NoticeModel>> getCreatedNotice(Map<String, dynamic>? bodydata) async {
    try {
      if (userId == null || token == null) {
        await init();
      }
      final url = 'api/MobileApp/master-admin/$userId/NoticeReport';
  ...
  Future<Map<String, dynamic>> deleteNotice(noticeId) async {
    try {
      if (userId == null && token == null) {
        await init();
      }

      final url = 'api/MobileApp/master-admin/$userId/$noticeId/RemoveNotice';
