...
class _DashboardState extends State<Dashboard> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async{
      ...
      final uiThemeProvider = Provider.of<UiThemeProvider>(context, listen: false).loadThemeSettingsFromApi(context);
          ...
          child: Column(
            children: [
              ...
              SliderCarouselWidget(
                data: dashboardProvider.sliderdata.map((item) => {
                  'key': item.key,
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Bargraph(
                        ...
                        colors: (uiTheme.graphColors != null && uiTheme.graphColors!.length >= 2)
                            ? uiTheme.graphColors!
