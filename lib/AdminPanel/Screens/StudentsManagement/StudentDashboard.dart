...
class _StudentDashboard extends State<StudentDashboard> {
  ...
  Widget build(BuildContext context) {
    ...
    final double fieldWidth = isSmallScreen
        ? screenWidth
        : (screenWidth - 52) / 2;
                ...
                FieldSet(
                  ...
                  child: Wrap(
                    ...
                    children: [
                      CustomDropdown(
                        items:
                            studentformdata?.house
                                .map((e) => {'id': e.id, 'house': e.house})
                                .toList() ??
                            [],
                        displayKey: 'house',
                        valueKey: 'id',
                  ...
                  child: Column(
                    children: [
                      CustomTextField(
                        ...
                        hintText: 'Enter SMS Contact No.',
                        controller: _smscontact,
                        validator: (value) {
                          if (value == null || value.trim().isEmpty) {
                      ...
                      CustomTextField(
                        ...
                        hintText: 'Enter Student Aadhaar No.',
                        controller: _aadhaar,
                      ),
                      SizedBox(height: 20),
                      CustomTextField(
                      ...
                      CustomTextField(
                        label: 'Father No.',
                        hintText: 'Enter Student Father No.',
                        controller: _fathercontact,
                      ),
                      SizedBox(height: 20),
                      CustomTextField(
                        label: 'Mother Name.',
                        hintText: 'Enter Student Mother Name.',
                        controller: _studentmother,
                      ),
                      SizedBox(height: 20),
                      CustomTextField(
                        label: 'Mother No.',
                        hintText: 'Enter Student Mother No.',
                        controller: _mothercontact,
                      ),
                      SizedBox(height: 20),
                      CustomDropdown(
                        items:
                            studentformdata?.transport
                                .map(
                                  (e) => {
                                    'route_id': e.route_id,
        ...
        child: CustomBlueButton(
          ...
          onPressed: () async {
            ...
            if (_formkey.currentState!.validate()) {
              ...
              try {
                var response = await StudentApis().submitStudentData(
                  studentData,
                );
