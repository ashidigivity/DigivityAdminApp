    ...
    try {
      setState(() {
        _filteredList = _originalList.where((student) {
          return (student['student_name']?.toLowerCase().contains(query) ??
                  false) ||
              (student['roll_no']?.toString().toLowerCase().contains(query) ??
                  false) ||
              (student['admission_no']?.toString().toLowerCase().contains(
                    query,
                  ) ??
                  false) ||
