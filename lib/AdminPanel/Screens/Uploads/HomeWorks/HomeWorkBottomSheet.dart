...
class ShowHomeworkDetailSheet extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text(hwDate, style: const TextStyle(color: Colors.grey)),
                ...
                Text(hwTitle, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
