...
class ExamTotalAttendsnaceSearch extends StatefulWidget{
  @override
  State<ExamTotalAttendsnaceSearch> createState() {
    return _ExamTotalAttendsnaceSearch();
  }
}



class _ExamTotalAttendsnaceSearch extends State<ExamTotalAttendsnaceSearch>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(preferredSize: Size.fromHeight(kToolbarHeight), child: SimpleAppBar(titleText: 'Search For Attendance', routeName: 'back')),
        ...
        children: [
          CardContainer(child:Form(
            ...
            children: [
              ...
              SizedBox(height: 20,),
              CustomDropdown(
                  label: 'Attendance Submit For', items:
              forattendance.map((e){
                return {
                  'id':e['id'],
                  'value':e['value']
      ...
      child: CustomBlueButton(text: 'Search', icon: Icons.search, onPressed: (){
        if(_formKey.currentState!.validate()){
          ...
          if(selectdForAttendance=='student'){
            context.pushNamed('student-total-attendance-entry',
            extra: {
            ...
            context.pushNamed('class-total-attendance-entry',
                extra: {
                  'courseId':selectedCourse,
                  'examTermId':selectedExamTerm,
                  'course':course,
